...
| size | `"md" | "default" | "sm" | "xs" | "lg" | "icon" | "icon-xs" | "icon-sm" | "icon-lg"` | `"default"` | Adjusts height and padding. Use xs or sm in dense toolbars, default/md for standard, lg for standout CTAs. Icon sizes: icon-xs, icon-sm, icon, icon-lg for square icon-only triggers. |
